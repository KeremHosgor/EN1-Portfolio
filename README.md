...
placeholder content — `Kerem Hosgor`, a generic hero image, and so on.
...
> Replace every "Kerem Hosgor" placeholder in this site with my name,
...
- [ ] Your name, replacing `Kerem Hosgor` everywhere it appears.
